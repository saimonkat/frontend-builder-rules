...
HTML-файлы в данной сборке используют стандартный [шаблонизатор](https://learn.javascript.ru/template-lodash) webpack. Чтобы изучить его синтаксис можно ознакомиться со статьей по ссылке. Ниже приведены все используемые конcтрукции:
...
3. Main контент страницы также разбиваем на файлы по секциям. Общие секции - в папку `/templates`, уникальные – во вложенную папку с именем страницы.
