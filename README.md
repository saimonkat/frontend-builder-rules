...
3. Main контент страницы также разбиваем на файлы по секциям. Общие секции - в папку elements/template-parts, Уникальные – в папку своей страницы  
    ...
    ❗ Каждая секция согласно HTML5 имеет тег `<section>` и должна содержать заголовок `<h1>`, `<h2>`, `<h3>`,  `<h4>` (_пропуск провоцирует ошибки валидации_)  
...
- Миксины брейпойнтов и повторяющихся стилей (mixins.scss)
